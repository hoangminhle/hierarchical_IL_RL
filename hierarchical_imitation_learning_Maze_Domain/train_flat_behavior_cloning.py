...
SUMMARY_NAME = 'fbc_1pass_1000maps_randomDoor_run4'
# General parameters
NUM_EPISODES = 1000
TEST_EPISODES = 1000
...
class Agent(Visualizable):
	def __init__(self, mode, env, direction):
		...
		if mode == 'train':
			...
			logdir = path.join('summary/flat_behavior_cloning/', SUMMARY_NAME) ## subject to change
...
if __name__ == '__main__':
	arg_parser = ArgumentParser('flat Behavior Cloning experiment')
